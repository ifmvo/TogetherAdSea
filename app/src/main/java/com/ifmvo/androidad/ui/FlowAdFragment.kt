...
import com.ifmvo.androidad.adExtend.FlowAdManager
 ...
 */
class FlowAdFragment : BaseRecyclerViewFragment<MutitypeBean, BaseViewHolder>() {
    ...
    override fun getData(currentPage: Int, showLoading: Boolean) {
        flTopView.postDelayed({
            ...
            val adList = FlowAdManager.getAdList()
            FlowAdManager.requestAd(3)
    ...
    override fun getRecyclerViewAdapter(): BaseQuickAdapter<MutitypeBean, BaseViewHolder> {
        return object : BaseMultiItemQuickAdapter<MutitypeBean, BaseViewHolder>(null) {
            ...
            init {
                ...
                addItemType(MutitypeBean.type_facebook, R.layout.list_item_facebook_flow)
            }
